...
'''
 题目描述：生成500个数据（x，y），其中y=x+n，n为高斯分布，平均值为0，标准差为delt。请使用线性回归学习算法从输入x估计y
'''
...
def learning_x_y(number,learning_rate,x,y):
    ...
    print("学习结束，一共学习了,",i,"次，最终误差为cost=",cost,"最终直线表达式为y=x+",round(theta,3))
